...
void process(cv::Mat& slam_in,
    ...
    std::cout << "Evaluation gave a score of "
              << eval.getMatthewsCCMedianPerZone()
              << " for the not straight segmentation, and "
              << evals.getMatthewsCCMedianPerZone()
              << " for the straight segmentation" << std::endl;
}
